...
const Navbar = () => {
  ...
  return (
    <div className="pt-5 border-b border-primary lg:border-gray-200 bg-primary lg:bg-white">
      {/* Navbar desktop */}
      ...
      <div className="flex md:h-16 justify-between items-center lg:hidden relative px-2 py-1 border-b container mx-auto">
